...
./binaire_test/zappy_server -p 4242 -x 20 -y 20 -n team1 team2 -c 6 -f 100 & SERVER_PID=$!
sleep 1

./zappy_gui -p 4242 -h localhost & GUI_PID=$!
sleep 1

for i in {1..3}; do
    ./zappy_ai -p 4242 -n team1 -h localhost -g 3d & TEAM1_PIDS[$i]=$!
    sleep 0.2
done
